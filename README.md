...
| <a name="input_region"></a> [region](#input\_region) | Scalingo region where to deploy the application. Can be set via the TF\_VAR\_region environment variable. | `string` | `"osc-fr1"` | no |
